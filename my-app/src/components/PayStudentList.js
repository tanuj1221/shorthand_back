...
const PayStudentList = () => {
    ...
    const fetchStudents = async () => {
        try {
            const response = await axios.get('http://15.206.159.230:3000/paystudents');
    ...
    const handlePayment = async (userInfo) => {
        ...
        try {
            const orderResponse = await axios.post('http://15.206.159.230:3000/createOrder', { amount });
            ...
            const options = {
                ...
                handler: async (response) => {
                    ...
                    const verificationResponse = await axios.post('http://15.206.159.230:3000/verifyPayment', {
    ...
    const handleDeleteStudent = async (studentId) => {
        ...
        if (window.confirm("Are you sure you want to delete this student?")) {
            try {
                await axios.delete(`http://15.206.159.230:3000/studentsdel/${studentId}`);
