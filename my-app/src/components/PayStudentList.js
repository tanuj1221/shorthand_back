...
const PayStudentList = () => {
    ...
    const fetchStudents = async () => {
        try {
            const response = await axios.get('http://65.0.31.147:3000/paystudents');
    ...
    const handleQRPayment = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://65.0.31.147:3000/verifyPayment1', {
                userInfo: userInfo, 
    ...
    const handlePayment = async (userInfo) => {
        ...
        try {
            const orderResponse = await axios.post('http://65.0.31.147:3000/createOrder', { amount });
            ...
            const options = {
                ...
                handler: async (response) => {
                    ...
                    const verificationResponse = await axios.post('http://65.0.31.147:3000/verifyPayment', {
    ...
    const handleDeleteStudent = async (studentId) => {
        ...
        if (window.confirm("Are you sure you want to delete this student?")) {
            try {
                await axios.delete(`http://65.0.31.147:3000/studentsdel/${studentId}`);
    ...
    return (
        <div className="student-list-container">
            ...
            <div className="payment-info">
                ...
                <a href="http://65.0.31.147:3000/#/refund-policy">View Refund Policy</a>
